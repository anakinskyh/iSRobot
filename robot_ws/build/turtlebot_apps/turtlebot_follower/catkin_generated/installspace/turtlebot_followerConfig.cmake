...
if("FALSE" STREQUAL "TRUE")
  set(turtlebot_follower_SOURCE_PREFIX /home/anakin/Workspace/Robot/robot_ws/src/turtlebot_apps/turtlebot_follower)
  set(turtlebot_follower_DEVEL_PREFIX /home/anakin/Workspace/Robot/robot_ws/devel)
  ...
  set(turtlebot_follower_INSTALL_PREFIX /home/anakin/Workspace/Robot/robot_ws/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlebot_follower' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/anakin/Workspace/Robot/robot_ws/install/${idir}'.  Ask the maintainer 'Daniel Stonier <stonier@rnd.yujinrobot.com>' to fix it.")
    endif()
